            ...
            <div class="wrap">
                ...
                <div class="user">
                    <div class="form-wrap">
                        <!-- TABS -->
                    	<div class="tabs">
                            <h3 class="login-tab"><a class="log-in active" href="#login-tab-content"><span>Inicia Sesión</span></a></h3>
                    	</div>
                        <!-- TABS CONTENT -->
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                    			<form class="login-form" id="form1" runat="server">
                    				...
                    				<asp:TextBox ID="txtUsername" runat="server" class="input" placeholder="Email" ViewStateMode="Disabled"></asp:TextBox>
                                    <asp:TextBox ID="txtPassword" TextMode="Password" runat="server" class="input" placeholder="Contraseña" ViewStateMode="Disabled"></asp:TextBox>

                                    <asp:Button ID="Button2" runat="server" class="button" Text="Entrar" OnClick="Button1_Click" />
                    			</form>
