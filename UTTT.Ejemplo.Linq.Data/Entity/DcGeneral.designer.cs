...
namespace UTTT.Ejemplo.Linq.Data.Entity
{
    ...
    partial void InsertCatStatusUsuario(CatStatusUsuario instance);
    partial void UpdateCatStatusUsuario(CatStatusUsuario instance);
    partial void DeleteCatStatusUsuario(CatStatusUsuario instance);
    ...
    partial void DeleteUsuario(Usuario instance);
		...
		public System.Data.Linq.Table<CatStatusUsuario> CatStatusUsuario
		{
			get
			{
				return this.GetTable<CatStatusUsuario>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CatStatusUsuario")]
	public partial class CatStatusUsuario : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnstrDescripcionChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CatStatusUsuario_Usuario", Storage="_Usuario", ThisKey="id", OtherKey="CatValorUsuario")]
		...
		{
			this.SendPropertyChanging();
			entity.CatStatusUsuario = this;
		}
		
		private void detach_Usuario(Usuario entity)
		{
			this.SendPropertyChanging();
			entity.CatStatusUsuario = null;
		}
	}
    ...
    partial void OnidCatEstadocivilChanging(int value);
    partial void OnidCatEstadocivilChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idCatEstadocivil", DbType="Int NOT NULL")]
		public int idCatEstadocivil
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Usuario", Storage="_Usuario", ThisKey="id", OtherKey="strNombrePersona")]
		public EntitySet<Usuario> Usuario
		{
			get
			{
		...
		public CatEstadoCivil CatEstadoCivil
		{
			...
			set
			{
							...
							|| (this._CatEstadoCivil.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._idCatEstadocivil = default(int);
					}
	...
	public partial class Usuario : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _strNombrePersona;
		
		private string _strUsuario;
		
		private string _strPassword;
		
		private int _CatValorUsuario;
		
		private System.DateTime _dteFechaRegistro;
		
		private string _strTokenRecorver;
		
		private EntityRef<CatStatusUsuario> _CatStatusUsuario;
    ...
    partial void OnidChanging(int value);
    partial void OnidChanged();
    partial void OnstrNombrePersonaChanging(int value);
    ...
    partial void OnCatValorUsuarioChanging(int value);
    partial void OnCatValorUsuarioChanged();
    partial void OndteFechaRegistroChanging(System.DateTime value);
    partial void OndteFechaRegistroChanged();
    partial void OnstrTokenRecorverChanging(string value);
    partial void OnstrTokenRecorverChanged();
    #endregion
		
		public Usuario()
		{
			this._CatStatusUsuario = default(EntityRef<CatStatusUsuario>);
			this._Persona = default(EntityRef<Persona>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_strNombrePersona", DbType="Int NOT NULL")]
		public int strNombrePersona
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CatValorUsuario", DbType="Int NOT NULL")]
		public int CatValorUsuario
		{
			get
			{
				return this._CatValorUsuario;
			}
			set
			{
				if ((this._CatValorUsuario != value))
				{
					if (this._CatStatusUsuario.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnCatValorUsuarioChanging(value);
					this.SendPropertyChanging();
					this._CatValorUsuario = value;
					this.SendPropertyChanged("CatValorUsuario");
					this.OnCatValorUsuarioChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_dteFechaRegistro", DbType="DateTime NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_strTokenRecorver", DbType="VarChar(255)")]
		public string strTokenRecorver
		{
			get
			{
				return this._strTokenRecorver;
			}
			set
			{
				if ((this._strTokenRecorver != value))
				{
					this.OnstrTokenRecorverChanging(value);
					this.SendPropertyChanging();
					this._strTokenRecorver = value;
					this.SendPropertyChanged("strTokenRecorver");
					this.OnstrTokenRecorverChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CatStatusUsuario_Usuario", Storage="_CatStatusUsuario", ThisKey="CatValorUsuario", OtherKey="id", IsForeignKey=true)]
		public CatStatusUsuario CatStatusUsuario
		{
			get
			{
				return this._CatStatusUsuario.Entity;
			}
			set
			{
				CatStatusUsuario previousValue = this._CatStatusUsuario.Entity;
				if (((previousValue != value) 
							|| (this._CatStatusUsuario.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CatStatusUsuario.Entity = null;
						previousValue.Usuario.Remove(this);
					}
					this._CatStatusUsuario.Entity = value;
					if ((value != null))
					{
						value.Usuario.Add(this);
						this._CatValorUsuario = value.id;
					}
					else
					{
						this._CatValorUsuario = default(int);
					}
					this.SendPropertyChanged("CatStatusUsuario");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Persona_Usuario", Storage="_Persona", ThisKey="strNombrePersona", OtherKey="id", IsForeignKey=true)]
		public Persona Persona
		{
			get
			{
			...
			set
			{
							...
							|| (this._Persona.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Usuario.Add(this);
						this._strNombrePersona = value.id;
					}
					else
					{
						this._strNombrePersona = default(int);
					}
					this.SendPropertyChanged("Persona");
				}
			}
